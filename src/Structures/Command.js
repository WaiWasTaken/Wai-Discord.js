...
class Command {
	 ...
	 * @typedef {{name: string, description: string, aliases: string, permission: Discord.PermissionString, type: CommandType, slashCommandOptions: Discord.ApplicationCommandOption[] run: RunFunction}} CommandOptions
